...
const first = new Good(1, "Hat", "color: blue, material: cotton", ["S", "M", "XL"], 1500, true);
const second = new Good(2, "Shirt", "color: orange, material: silk", ["S", "M", "L"], 10000, true);
const third = new Good(3, "Hoodies", "color: yellow, material: leather", ["XS", "M", "XXL"], 35000, true);
const fourth = new Good(4, "Socks", "color: black, material: cotton", ["S", "M", "L", "XL"], 8000, true);
const fifth = new Good(5, "T-shirt", "color: grey, material: cotton", ["L", "XL"], 4500, true);
